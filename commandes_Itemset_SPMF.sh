...
## ------------- FPClose itemsets
# minsup: 40%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_40.txt 0.40

# minsup: 50%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_50.txt 0.50

# minsup: 60%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_60.txt 0.60

# minsup: 70%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_70.txt 0.70

# minsup: 80%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_80.txt 0.80

# minsup: 90%
java -jar spmf.jar run FPClose GrandEst_encode.txt output_spmf_item_fpc_90.txt 0.90
